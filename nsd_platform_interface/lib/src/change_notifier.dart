// This is just a quick and dirty fix to not include `dart:ui`

const bool _kMemoryAllocations = bool.fromEnvironment('flutter.memory_allocations');

mixin class DartChangeNotifier implements Listenable {
  int _count = 0;
  ...
  static bool debugAssertNotDisposed(DartChangeNotifier notifier) {
    assert(() {
  ...
  void addListener(VoidCallback listener) {
    assert(DartChangeNotifier.debugAssertNotDisposed(this));

    if (_kMemoryAllocations) {
